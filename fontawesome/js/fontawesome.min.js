!(function() {
    ...
    (ht.prototype = {
        ...
        then: function(t, e) {
            ...
            return (
                (!e && !t) || this._handled || ((this._handled = !0), this._state === Z && tt && rt(mt, this)),
    ...
    function Ot(t) {
        ...
        var b,
            ...
            F,
            Y,
            D = B({}, v, { prefix: r, iconName: i, main: n, mask: a, transform: o, symbol: c, styles: l.styles }),
            q =
                a.found && n.found
                    ? ((y = (b = D).children),
                      (w = b.attributes),
    ...
    function Et(t) {
        ...
        var f,
            ...
            y = B({}, o.styles);
        St(r) &&
            ((y.transform = ((u = (f = { transform: r, startCentered: !0, width: n, height: a }).transform),
            (d = f.width),
            (m = void 0 === d ? A : d),
            (h = f.height),
            (p = void 0 === h ? A : h),
            ...
            (b +=
                (v = void 0 !== g && g) && k
                    ...
                    : v
                    ? 'translate(calc(-50% + '.concat(u.x / gt, 'em), calc(-50% + ').concat(u.y / gt, 'em)) ')
        ...
        de = {
            ...
            children: [
                fe,
                {
                    ...
                    children: [
                        { tag: 'animate', attributes: B({}, le, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
    ...
    var Oe,
        ...
        Te = function() {
            var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
                e = void 0 === t ? p : t;
            (0 < Object.keys(D.styles).length || V.autoFetchSvg) && g && V.autoReplaceSvg && _e.dom.i2svg({ node: e });
        };
    !(function(t) {
        try {
            t();
